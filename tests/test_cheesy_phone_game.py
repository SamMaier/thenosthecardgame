...
class CheesyPhoneGameTests(unittest.TestCase):
    def test_printed_values_and_base_fun(self) -> None:
        game = empty_game()
        player = game.players[0]
        player.energy = 1
        player.hand.append(make_card("cheesy-phone-game"))
    ...
    def test_bonus_requires_two_of_three_opponents_to_play_relax_cards(self) -> None:
        game = empty_game()
    ...
    def test_one_opponent_or_non_relax_cards_do_not_qualify(self) -> None:
        ...
        other_opponent.hand.append(make_card("tres-fute"))
        game.play_card(2, 0)
    ...
    def test_active_tomorrow_relax_cards_do_not_count_as_previously_played(self) -> None:
        game = empty_game()
